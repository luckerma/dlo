...
\begin{frame}[fragile]{YOLO}
  ...
  \end{itemize}
  \onslide<3->
  \begin{lstlisting}[caption={\textit{ultralytics}-Paket installieren},language=Bash,gobble=4,xleftmargin=\leftmargini,xrightmargin=\leftmargini]
    pip install ultralytics
  \end{lstlisting}
  \onslide<4->
  \begin{lstlisting}[caption={YOLO-Modell verwenden},language=Python,gobble=4,xleftmargin=\leftmargini,xrightmargin=\leftmargini]
