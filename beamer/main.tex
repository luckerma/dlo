        ...
        \begin{column}{0.4\textwidth}
            \begin{itemize}
                ...
                \item[]
                      ...
                      \only<2>{\item<2-3> $TP$: True Positives
                \item $FP$: False Positives
                \item $FN$: False Negatives
                      }

                \item<3->\textbf{Precision:}\\Wie viele der erkannten Objekte sind tatsächlich Objekte?\\$\rightarrow$ "`Treffsicherheit"'
                \item<4->\textbf{Recall:}\\Wie viele der tatsächlich vorhandenen Objekte wurden erkannt?\\$\rightarrow$ "`Erfassungsrate"'
            \end{itemize}
        \end{column}
        \begin{column}{0.6\textwidth}
            \begin{figure}
